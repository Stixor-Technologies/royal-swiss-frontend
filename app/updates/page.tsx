...
const Updates = () => {
  ...
  const EventsPage = useRef<HTMLElement | null>(null);
  ...
  return (
    <section ref={EventsPage} className="relative z-[1] md:pt-[1.125rem]">
      ...
      <div className="container">
        ...
        {loading ? (
          ...
          <div className="mb-[6.5rem] mt-[7.438rem] grid grid-cols-1 gap-10 sm:mt-[4.688rem] sm:grid-cols-2 sm:gap-8 md:mb-[6.75rem] lg:gap-x-[3.563rem] lg:gap-y-20">
          ...
          <div className="flex min-h-[60vh] items-center justify-center">
            <h6 className="font-righteous text-3xl tracking-wide text-indigo-blue">
              No Events Found
            </h6>
          </div>
        )}
