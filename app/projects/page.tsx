...
const Projects = () => {
  ...
  const projectsPage = useRef<HTMLElement | null>(null);
  ...
  return (
    <section ref={projectsPage} className="relative z-[1] md:pt-[1.125rem]">
      <div className="absolute -top-28 left-0 right-0 -z-10 mx-auto hidden w-full max-w-[120rem] flex-col justify-center overflow-hidden lg:top-0 xl:top-1 2xl:!top-20 xs:block">
        <svg
          height={590}
      ...
      <div className="container">
        ...
        {loading ? (
          ...
          projects?.length > 0 && (
            <div className="mt-[4.688rem] grid grid-cols-1 gap-10 sm:grid-cols-2 sm:gap-8 md:mt-[5.313rem]   lg:gap-x-[4.625rem] xl:gap-y-0">
