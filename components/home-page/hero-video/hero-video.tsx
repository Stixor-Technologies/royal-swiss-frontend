...
const HeroVideo = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container z-10 lg:pb-[4.5rem] lg:pt-[9.688rem]">
        <div className="absolute -inset-10 -right-80 -z-[10] mx-auto hidden max-w-[120rem] flex-col justify-center xs:flex">
          <svg
            height="1095"
            viewBox="0 0 1900 695"
            fill="none"
