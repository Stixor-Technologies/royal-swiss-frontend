        ...
        >
          <div className="container px-0">
            ...
            <div className="flex lg:gap-x-14">
              ...
              <div className="mt-[1.313rem] hidden items-start justify-center gap-3 !px-4 text-black sm:col-span-1 sm:col-start-auto sm:row-start-auto sm:mt-0 sm:flex sm:justify-end sm:!px-8 lg:gap-6 lg:!px-[2.625rem]">
                <button
                  className="group relative size-[1.953rem] rotate-90 sm:size-10 lg:size-[5rem]"
                  aria-label="Previous page"
                  onClick={() => {
            ...
            <div className="relative mt-3 h-[19.5rem] w-full cursor-pointer overflow-visible md:mt-10 md:h-[24.5rem] lg:h-[37.438rem]">
              <div className="absolute left-0 list-none overflow-visible">
                <Swiper
                  slidesPerView={"auto"}
                  freeMode={true}
                  ...
                  className="!overflow-visible !px-4 sm:!px-8 lg:!px-[2.625rem]"
                >
                  {team?.map((member, index) => {
                    return (
                      <SwiperSlide
            ...
            <div className="mt-[1.313rem] flex items-start justify-center gap-3 !px-4 text-black sm:mt-0 sm:hidden sm:justify-end sm:!px-8 lg:gap-6 lg:!px-[2.625rem]">
              <button
                className="group relative size-[1.953rem] rotate-90 sm:size-10 lg:size-[5rem]"
                aria-label="Previous page"
                onClick={() => {
