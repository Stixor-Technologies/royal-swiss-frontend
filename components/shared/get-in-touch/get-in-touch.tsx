...
const GetInTouch = () => {
  ...
  return (
    <section
      id="get-in-touch"
      className="bg-[url('/images/bg-assets/contact-section-mobile.png')] bg-contain bg-[center_top] bg-no-repeat pb-10 pt-[7.17rem] lg:mt-[3.75rem] lg:pb-[5.813rem] lg:pt-[9.188rem] 2xl:bg-cover xs:bg-[url('/images/bg-assets/contact-section-web.png')] xs:bg-left-top"
    >
